...
| Histograms      |`metrics.histogram(key, value[, tags[, timestamp[, options]]])`|Samples a histogram value. `tags`, `timestamp`, and `options` are optional.|
